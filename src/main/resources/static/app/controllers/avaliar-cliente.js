(function() {
	...
	function AvaliarClienteController($http, $scope, AuthService, $stateParams) {
		...
		function submit_bioimpedancia() {
			...
			$http.post('cadastrar_bioimpedancia', vm.bioimpedancia).success(function(res) {
		...
		function submit_questionario() {
			...
			$http.post('cadastrar_questionario', vm.questionario).success(function(res) {
		...
		function submit_plano_terapeutico() {
			...
			$http.post('cadastrar_planto_terapeutico', vm.planto_terapeutico).success(function(res) {
		...
		function submit_anamnese() {
			...
			$http.post('cadastrar_anamnese', vm.anamnese).success(function(res) {
				console.log(vm.bioimpedancia);
				vm.anamnese = null;
